...
extern "C"{
JNIEXPORT jlong JNICALL Java_com_ifinver_finengine_FinRender_nativeCreate(JNIEnv *env, jobject instance, jobject output);
JNIEXPORT void JNICALL Java_com_ifinver_finengine_FinRender_nativeRelease(JNIEnv *env, jobject instance,jlong engine);
JNIEXPORT void JNICALL Java_com_ifinver_finengine_FinRender_nativeRenderOut(JNIEnv *env, jobject instance,jlong engine,jobject input);
