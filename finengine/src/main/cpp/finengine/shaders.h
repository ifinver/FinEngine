...
public:
    ShaderNV21() {
        fragmentShader =
                        ...
                        "                                                                               \n"
                        "   vec3 newColor1 = texture2D(cleanTexture, texPos1).rgb;                \n"
                        "   vec3 newColor2 = texture2D(cleanTexture, texPos2).rgb;                \n"
                        "                                                                                      \n"
                        "   vec3 newColor = mix(newColor1, newColor2, fract(blueColor));                                    \n"
//                        "   gl_FragColor = mix(textureColor, vec4(newColor.rgb, 1.0), 1.0);                                    \n"
