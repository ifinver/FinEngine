...
JNIEXPORT void JNICALL Java_com_ifinver_facedetect_FaceDetector_nativeSetProcessModel(JNIEnv *env, jclass type, jlong model);
JNIEXPORT void JNICALL Java_com_ifinver_facedetect_FaceDetector_nativeSetFaceBrightLevel(JNIEnv *env, jclass type, jint brightLevel);
JNIEXPORT void JNICALL Java_com_ifinver_facedetect_FaceDetector_nativeSetFaceSkinSoftenLevel(JNIEnv *env, jclass type, jint skinSoftenLevel);
}
